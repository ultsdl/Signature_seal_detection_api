...
class YOLO(object):
    _defaults = {
        "model_path": 'yolo3/trained_weights_final.h5',
...
def main():
    ...
    _, img_encoded = cv2.imencode('.jpg', r_image)
...
# curl.exe -X POST -F image=@test4.jpg 'http://localhost:5000/predict' --output ot.jpg
